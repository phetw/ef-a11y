...
import { ControlElement, css, customElement, html, property, query, styleMap, WarningNotice, FocusedPropertyKey, eventOptions } from '@refinitiv-ui/core';
...
let ComboBox = class ComboBox extends ControlElement {
    ...
    firstUpdated(changedProperties) {
        ...
        // this.setAttribute('aria-owns', 'list123');
    ...
    */
    ...
    get inputTemplate() {
      ...
      <ef-text-field
        ...
        aria-activedescendant="${this.composer.queryItemsByPropertyValue('highlighted', true).length ? this.composer.queryItemsByPropertyValue('highlighted', true)[0].id : ''}"
      ...
      <div tabindex="-1" id="toggle-button" role="button" part="button button-toggle" aria-label="Open">
